...
public class RdbtoolMainTest {
	...
	public static void main(String[] args) {
		System.out.println(generateCsv("D:/下载/dump1.rdb", "D:/下载11/",
				new String[] { "selfstock.tzt.user.", "selfstock.tzt.stock." }));
//		System.out.println(generateCsv("D:/下载/dump1.rdb", "D:/下载11/", null));
	}
